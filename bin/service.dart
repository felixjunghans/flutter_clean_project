...
// base path for service files
const String BASE_PATH = 'lib/data/services';
...
void main(List<String> arguments) async {
  ...
  if (packageName != null) {
    final parser = ArgParser()
      ..addOption('servicePath', defaultsTo: BASE_PATH, abbr: 'p');
    argResults = parser.parse(arguments);

    final String servicePath = argResults['servicePath'];
    ...
    if (name == null) {
      ...
      pathToScreen = '$servicePath/${name.snakeCase}';
      ...
      if (await Directory(pathToScreen).exists()) {
        ...
        // generate files
        await copyAndRenameTemplate(Directory('$libraryPath/service_template'),
...
Future<void> copyAndRenameTemplate(
  ...
  await for (var entity in source.list(recursive: false)) {
    ...
    if (entity is Directory) {
      ...
      await file.replaceAll('package:flutter_clean_project/service_template',
